...
const AnimatedProjectCard = ({ project }) => {
  ...
  return (
    <div
      ref={ref}
      key={project.id}
      className={`project-card-hover bg-slate-50 rounded-xl border border-slate-200 overflow-hidden shadow-xl shadow-slate-200 transition-all duration-300 ${inView ? 'animate__animated animate__fadeInUp' : ''}`}
    >
      {/* Gambar */}
