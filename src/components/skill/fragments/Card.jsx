    ...
    <div className='w-full mx-auto'>
      <Marquee className='w-full' pauseOnHover repeat={2}>
        {skills.map((skill) => (
          ...
          >
            <div className='bg-slate-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-md hover:scale-[1.02] transition-all duration-300 flex items-center p-3 sm:p-4 group cursor-pointer overflow-hidden min-w-fit'>
