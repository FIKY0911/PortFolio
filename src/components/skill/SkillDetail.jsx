...
const AnimatedSkillCard = ({ tech, index }) => {
  ...
  return (
    <div
      ref={ref}
      className={`bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 ${inView ? 'animate__animated animate__fadeInUp' : ''}`}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Setiap proyek dibangun dengan alat yang tepat. Berikut detail framework dan bahasa pemrograman yang saya gunakan dalam pengembangan.
          </p>
        </div>
